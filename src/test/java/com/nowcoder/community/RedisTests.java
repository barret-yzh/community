...
public class RedisTests {
    ...
    public void testSets() {
        ...
        redisTemplate.opsForSet().add(redisKey, "刘备", "关羽", "张飞", "赵云", "诸葛亮","赵云");
    ...
    public void testSortedSets() {
        ...
        System.out.println(redisTemplate.opsForZSet().reverseRank(redisKey, "悟空"));//0
        System.out.println(redisTemplate.opsForZSet().rank(redisKey, "悟空"));//4
        System.out.println(redisTemplate.opsForZSet().reverseRange(redisKey, 0, 2));//[0,2]/
    }
    ...
    public void testTransactional() {
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations operations) throws DataAccessException {
                ...
                System.out.println(operations.opsForSet().members(redisKey));//事务提交前查询无效 数据为空[]
    ...
    public void testHyperLogLog() {
        ...
        for (int i = 1; i <= 100000; i++) {
            int r = (int) (Math.random() * 1000 + 1);//[1,1000]
    ...
    public void testBitMap() {
        ...
        //统计为1的个数
        Object obj = redisTemplate.execute((RedisCallback) redisConnection -> redisConnection.bitCount(redisKey.getBytes()));
